...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/14 17:33:21 by tmkrtchy          #+#    #+#             */
/*   Updated: 2021/04/14 17:33:22 by tmkrtchy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/cylinder.h"

t_cylinder	*new_cylinder(t_vec p, t_vec normal, double radius, double height)
{
	t_cylinder *cylinder;
								...
								t_ray ray)
{
	...
	if (!solve_discr(new_qparams(a, b, c), t0, t1))
		return (0);
	return (1);
}
